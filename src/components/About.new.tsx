...
const pillars = [
  {
    title: 'Connect',
    text: 'Meet thoughtful creatives across disciplines and build relationships that last.',
  },
  {
    title: 'Create',
    text: 'Share ideas, collaborate on projects, and make room for bold new work.',
  },
  {
    title: 'Grow',
    text: 'Learn from peers, join meaningful events, and shape your next chapter with support.',
  },
];
      ...
      <div className="site-container relative">
        ...
        <div className="rounded-[32px] border border-ink/10 bg-white/75 p-6 shadow-[0_30px_80px_rgba(17,17,17,0.08)] backdrop-blur-sm sm:p-8 lg:p-10">
          <div className="grid items-center gap-8 lg:grid-cols-[45%_55%] lg:gap-12">
            ...
            >
              <div className="overflow-hidden rounded-[20px] border border-white/70 bg-white shadow-[0_24px_70px_rgba(17,17,17,0.14)]">
                <motion.img
            ...
            >
              ...
              <p className="mt-5 max-w-xl font-body text-base leading-relaxed text-ink/65 sm:text-[17px]">
              ...
              <div className="mt-8 space-y-3">
                {pillars.map((pillar) => (
                  <div key={pillar.title} className="rounded-2xl border border-ink/8 bg-white/80 px-4 py-3 shadow-sm">
                    <h3 className="font-display text-lg font-semibold text-ink">{pillar.title}</h3>
                    <p className="mt-1 font-body text-sm leading-relaxed text-ink/60">{pillar.text}</p>
                  </div>
                ))}
              </div>
